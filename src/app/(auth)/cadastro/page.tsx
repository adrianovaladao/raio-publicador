              ...
              <form onSubmit={handleSignUp}>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: 10, marginTop: 16 }}>
                  ...
                  <span style={{ fontSize: 12.5, color: "rgba(255,255,255,0.55)", lineHeight: 1.5 }}>
                    Autorizo o Raio Publicador a enviar novidades, dicas e atualizações por e-mail. Esta autorização é necessária para uso da plataforma. Você poderá alterar essa opção após o acesso à sua conta.
                  </span>
                </div>
