...
const PLANS = [
  {
    ...
    feats: [
      ...
      ["Até 2 publicações em portais categ. A", true],
  ...
  },
  {
    ...
    feats: [
      ...
      ["Até 10 publicações em portais categ. A", true],
      ["Acesso completo aos 50 portais parceiros", true],
      ["Calendário e agendamento inteligente", true],
      ["Até 3 editores incluídos", true],
  ...
  },
  {
    ...
    feats: [
      ...
      ["Até 20 publicações em portais categ. A", true],
      ["Acesso completo aos 50 portais parceiros", true],
      ["Calendário e agendamento inteligente", true],
      ["Até 5 editores incluídos", true],
      ["Suporte prioritário", true],
    ],
...
const TESTIMONIALS = [
  ...
  { q: <>Negociar publicações individualmente consumia dias de trabalho. Com o Raio, basta escolher os portais, subir o artigo e <em>acompanhar os links publicados de forma garantida</em>.</>, nm: "Leticia da Costa", rl: "Diretora de marketing", av: "LC", photo: "/assets/testimonials/leticia-costa.jpg" },
  { q: <>O custo por publicação garantida foi o grande diferencial. Economizamos mais de 60% em relação ao <em>modelo antigo de disparo de releases em massa</em> e mantivemos nossa marca em destaque e na pauta de grandes veículos do país.</>, nm: "Renato Novaes", rl: "Diretor de expansão", av: "RN", photo: "/assets/testimonials/renato-novaes.jpg" },
];
  ...
  return (
    <nav className={`nav${scrolled ? " scrolled" : ""}`}>
      <div className="nav-in">
        <a className="lock" href="#top" onClick={close}><RaioLockup height={33} variant="dark" /></a>
        <div className="links">
      ...
      <div className="wrap">
        <div className="top">
          <div className="brand-col">
            <a href="#top"><RaioLockup height={29} variant="dark" /></a>
