          ...
          {groups.map((group, gi) => (
            <div key={group}>
              ...
              {(Object.entries(NOTIF_LABELS) as [NotifType, { title: string; desc: string; group: string }][])
                ...
                .map(([type, meta]) => (
                  <div key={type} style={{ display: "flex", alignItems: "center", padding: "0 22px 42px", gap: 8 }}>
                    <div style={{ flex: 1, minWidth: 0 }}>
...
function CobrancaPanel({ onToast, isCancelled }: { onToast: (m: string) => void; isCancelled?: boolean }) {
  ...
  return (
    <div className="set-panel">
      ...
      <div className="card" style={{ marginTop: 16 }}>
        <div className="card-head">
          <h3>Resgatar voucher de créditos</h3>
        </div>
        <div className="card-pad" style={{ paddingTop: 16 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
            <span style={{ fontSize: 13, color: "var(--fg-muted)" }}>
              Tem um código de voucher? Insira ao lado para adicionar créditos à sua conta.
            </span>
